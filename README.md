...
Jot Deck は、キーボード操作特化型のローカルファースト・メモアプリです。TweetDeck のようなカラム型 UI で、断片的なアイデアを高速に入力・整理します。将来的には Deck を MCP サーバとして開き、手元の AI エージェント（Claude 等）から読み書きできるようにする予定です。
...
- **AI 連携（ローカルファースト・開発予定）** - Deck を MCP サーバとして開き、手元の AI エージェントからナレッジベースとして読み書き
